...
function ProblemSet() {
    ...
    async function getAllProblems() {
        setIsLoading(false);
        let response = await fetch("https://one-profile-server.vercel.app/problemset/", {
            method: 'GET'
        });
    ...
    async function checkBoxClick(link) {
        ...
        let respo = await fetch("https://one-profile-server.vercel.app/problemset/changestatus", {
            method: 'POST',
            headers: {
